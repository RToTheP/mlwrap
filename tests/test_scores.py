...
def test_print_scores():
    # arrange
    scores_ = {ScoreType.recall_macro: 0.5, ScoreType.recall_weighted: 0.75}
    # act
...
def test_get_scores_classification():
    ...
    assert pytest.approx(scores_[ScoreType.recall_weighted]) == 2/3
...
def test_get_scores_regression():
    ...
    assert pytest.approx(scores_[ScoreType.mean_absolute_error]) == 0.2     
